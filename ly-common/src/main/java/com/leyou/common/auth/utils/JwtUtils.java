...
public class JwtUtils {
    ...
    public static void main(String[] args) throws Exception {
        //1.加密，产生token
        //参数一:数据对象
        UserInfo userInfo = new UserInfo(1L,"henry","vip");
        //参数二:私钥
        PrivateKey privateKey = RsaUtils.getPrivateKey("E:\\IdeaProjects\\leyoumall\\id_rsa");
        //参数三:失效时间
        ...
        //参数一:token
        //参数二:公钥
        PublicKey publicKey = RsaUtils.getPublicKey("E:\\IdeaProjects\\leyoumall\\id_rsa.pub");
        //参数三:类型
